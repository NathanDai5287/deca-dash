...
export default function Entrepreneurship() {
  ...
  const checkAnswer = (questionIndex) => {
    const correctAnswer = data.Entrepreneurship[questionIndex].correctAnswerIndex;
    ...
    setExplanations({
      ...explanations,
      [questionIndex]: isCorrect ? "Correct! " + data.Entrepreneurship[questionIndex].explanation : "Incorrect, try again!",
    });
  };

  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold text-center my-6">Entrepreneurship Questions</h1>
      <div>
        {data.Entrepreneurship.map((item, questionIndex) => (
